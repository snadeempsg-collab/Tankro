...
import { formatInRupees, getDaysRemaining, getTodayDateString, addMonths } from '../utils';
...
export default function SubscriptionList({ jobs, onQuickLogJob }: SubscriptionListProps) {
              ...
              >
                <div className="space-y-1">
                  ...
                  <p className="text-[10px] text-slate-500 font-semibold flex items-center gap-1.5">
                    Phone: {sub.customerPhone} | Area: {sub.area}
                  </p>
                ...
                <div className="flex items-center justify-end">
                  <button
                    ...
                    className="flex items-center gap-1.5 px-4 py-2.5 bg-blue-600 hover:bg-blue-700 text-white rounded-2xl text-xs font-bold transition-all shadow-md shadow-blue-50 cursor-pointer w-full md:w-auto justify-center"
